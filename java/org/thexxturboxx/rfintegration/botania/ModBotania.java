...
public class ModBotania {
	...
	public static final String NAME = "Botania Integration";
    ...
    @SidedProxy(modId = ID,
    		clientSide = "org.thexxturboxx.rfintegration.botania.ClientProxy",
    		serverSide = "org.thexxturboxx.rfintegration.botania.CommonProxy")
