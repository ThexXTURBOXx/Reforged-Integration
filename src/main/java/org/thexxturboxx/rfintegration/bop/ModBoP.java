...
public class ModBoP {
	...
	public static final String NAME = "Reforged Biomes O' Plenty Integration";
	public static final String ID = "reforgedbop";

	@Instance(ID)
	public static ModBoP instance;

	@SidedProxy(modId = ID, clientSide = "org.thexxturboxx.rfintegration.bop.ClientProxy", serverSide = "org.thexxturboxx.rfintegration.bop.CommonProxy")
