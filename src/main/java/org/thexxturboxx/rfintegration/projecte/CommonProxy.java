...
public class CommonProxy extends ProxyBase {
	...
	public void preInit(FMLPreInitializationEvent event) {
		super.preInit(event);
		Registry.registerItems(ModProjectE.ID, regListItems);
	}
	...
	public void registerMatDefs() {
		MaterialManager.addMaterialDefinition(ProjectE_DarkMatter, new MaterialDefinition("dark_matter",
				ProjectE_DarkMatter, new ItemStack(moze_intel.projecte.gameObjs.ObjHandler.matter, 1, 0)));
		MaterialManager.addMaterialDefinition(ProjectE_RedMatter, new MaterialDefinition("red_matter",
				ProjectE_RedMatter, new ItemStack(moze_intel.projecte.gameObjs.ObjHandler.matter, 1, 1)));
	}
}
