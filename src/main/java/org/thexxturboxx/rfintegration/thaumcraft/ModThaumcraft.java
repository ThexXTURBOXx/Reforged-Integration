...
public class ModThaumcraft {
	...
	public static final String NAME = "Reforged Thaumcraft Integration";
	public static final String ID = "reforgedthaumcraft";

	@Instance(ID)
	public static ModThaumcraft instance;

	@SidedProxy(modId = ID, clientSide = "org.thexxturboxx.rfintegration.thaumcraft.ClientProxy", serverSide = "org.thexxturboxx.rfintegration.thaumcraft.CommonProxy")
