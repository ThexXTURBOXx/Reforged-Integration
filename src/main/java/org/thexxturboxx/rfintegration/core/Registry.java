...
public class Registry {
	 ...
	 */
	public static void registerEntity(String modid, Class c, String name) {
		EntityRegistry.registerModEntity(new ResourceLocation(modid, name), c, name, ++counterEntities, ModReforgedIntegration.instance, 120, 1, true);
	}
	...
	public static void registerItems(String modid, List<Item> regListItems) {
